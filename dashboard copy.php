...
// Generate a secure session token for the deep link
$session_id = session_id(); // Or use a more secure token if you have one
$deep_link = "tracked://auth/login?session_id=" . urlencode($session_id);
?>
<!DOCTYPE html>
<html lang="en">
<head>
